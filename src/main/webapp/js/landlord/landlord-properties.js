...
function deleteSelected() {
    ...
    if (confirm(`Delete ${selected.length} selected property(s)? This action cannot be undone.`)) {
...
function viewProperty(displayId) {
    window.location.href = window.contextPath + '/landlord/properties?action=view&id=' + displayId;
}
